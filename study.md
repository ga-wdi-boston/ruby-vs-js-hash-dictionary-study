...
# ** Question** Why will the solution above not work? Is it because I'm mixing
# single quotes and double quotes in one?
...
# Changed around quotes and this seems to work
```
...
dale[:hobbies] = ['drinkinb beer', 'conspiracy theories']

# => {:family_name=>"gribble",
#  :"given-name"=>"dale",
#  :occupation=>"exterminator",
#  :"middle name"=>"Alvin",
#  :hobbies=>["drinkinb beer", "conspiracy theories"]}
```
...
```ruby
puts "My name is #{dale[:'given_name']} #{dale[:family-name]} and I'm an
