...
```ruby
dale[:family_name]="gribble".capitalize!
dale[:"given-name"]=:"dale".capitalize!
```
...
let hank = {
  familyName: "hill",
  givenName: "hank",
  occupation: "propane and propane accesories salesman"
};
```
...
hank["hobbies"]= ["drinking beer", "propane and propane accesories"];
...
```javascript
"My name is ${hank['givenName']} ${hank['familyName']} and I'm a ${hank['hobbies'][1]} salesman that enjoys ${hank['hobbies'][0]}.";
