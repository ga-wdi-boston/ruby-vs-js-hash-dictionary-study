...
```ruby
# The punctuation is throwing me off, I'm not really sure what is being asked.
...
```javascript
const sentence = 'My name is ${hank[given-name]} ${hank.family_name} and I'm an ${hank.occupation} that enjoys ${hank.hobbies[0]}.'
```
