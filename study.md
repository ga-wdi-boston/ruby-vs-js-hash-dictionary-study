...
```ruby
dale_keys = "dale's keys"
dale_values = "dale's values"
...
puts "My name is #{name.capitalize} Gribble and I'm an exterminator that enjoys
conspiracy theories."
```
...
```javascript
hank.hankKeys = ["hank's keys"]
hank.values = ["hank's values"]
```
...
string = "My name is " + givenName.capitalizeFirstLetter() + " " + familyName.capitalizeFirstLetter() + " and I'm a propane and propane accessories salesman that enjoys drinking beer."
```
