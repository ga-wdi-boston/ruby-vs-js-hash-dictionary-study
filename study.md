...
```javascript
const hank = {family_name: "hill", given_name: "hank", occupation: "propane and propane accessories salesman"}
```
...
```java script
let newString = 'My name is ${hank.given_name} ${hank['family_name']} and I'm an ${hank['occupation']} that enjoys ${hank.hobbies[0]}.'
```
