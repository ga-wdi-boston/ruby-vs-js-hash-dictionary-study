...
# Output: {:family_name=>"gribble", :given_name=>"dale", :occupation=>"exterminator"}
```
...
```javascript
sentence = "My name is " + hank.given_name + " " + hank.family_name + " " + " and I\'m a " + " " + hank.occupation + " that enjoys " + hank.hobbies[0] + "."
```
