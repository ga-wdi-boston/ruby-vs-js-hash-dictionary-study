...
dale[:dale_keys] = "dale's keys"
dale[:dale_values] = "dale's values"
```
...
```ruby
print "My name is #{dale[:given_name]} #{dale[:family_name]} and I'm an #{dale[:occupation]} that enjoys #{dale[:hobbies][1]}."
```
