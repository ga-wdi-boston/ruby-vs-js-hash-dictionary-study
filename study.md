...
```ruby
p "My name is #{:given_name} #{:family_name} and I'm an #{:occupation} that enjoys #{:hobbies[1]}."
```
...
```javascript
hank.capitalize(middle_name)
hank.capitalize(given_name)
```
...
```javascript
let string = "My name is " + this.given_name + " " + this.surname + " and I am a " + this.occupation + " that enjoys " + this.hobies[1].;```
